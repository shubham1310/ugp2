...
if __name__ == "__main__":
    ...
    b=os.listdir(sourceDir)
    for ab in b:
        npath=os.path.join(sourceDir,ab)
        ...
        for bc in c:
            ...
            for fil in im_filelist:
                ...
                count += 1
                im = cv2.imread(fil).astype(np.float32)
            ...
            imlfile = open(newdir2+'features.csv', 'w')
